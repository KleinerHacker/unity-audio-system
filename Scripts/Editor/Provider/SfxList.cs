...
namespace UnitySfx.Editor.sfx_system.Scripts.Editor.Provider
{
    public sealed class SfxList : ReorderableList
    {
        ...
        private const float AmbienceMinDelayWidth = 150f;
        private const float AmbienceMaxDelayWidth = 150f;
        ...
        private void DrawHeaderCallback(Rect rect)
        {
            ...
            EditorGUI.LabelField(pos, new GUIContent("Ambience Min Delay"));

            pos = new Rect(rect.x + LeftMargin + commonWidth + AmbienceMinDelayWidth, rect.y, AmbienceMaxDelayWidth, rect.height);
            EditorGUI.LabelField(pos, new GUIContent("Ambience Max Delay"));
            ...
            EditorGUI.LabelField(pos, new GUIContent("Initial Value"));
        }
        ...
        private void DrawElementCallback(Rect rect, int i, bool isactive, bool isfocused)
        {
            ...
            var initialValueProperty = subProperty.FindPropertyRelative("initialValue");
            ...
            EditorGUI.PropertyField(pos, initialValueProperty, GUIContent.none);
        }
    }
}